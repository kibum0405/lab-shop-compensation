    ...
    save = async() =>{
        try {
            ...
            if(!this.props.offline) {
                if(this.props.isNew) {
                    temp = await axios.post(axios.fixUrl('/inventories'), this.props.value);
            ...
            <React.Fragment>
                <CardHeader
                    title={
                        ...
                        <Typography variant="h5" component="div">
                            Inventory # {this.props.value._links.self.href.split("/")[this.props.value._links.self.href.split("/").length - 1]}
                        </Typography>:
                        <Typography variant="h5" component="div">
                            Inventory
                        </Typography>
                ...
                <CardContent className="aggre-gate-root-card-content-style">
                    <Typography className="aggre-gate-root-typography-style" color="text.secondary">
                        <Number name="stock" label="stock" onChange={this.props.onChange} value={this.props.value.stock?this.props.value.stock:""} editMode={this.props.editMode}/>
                    </Typography>
                </CardContent>
                <CardActions>
