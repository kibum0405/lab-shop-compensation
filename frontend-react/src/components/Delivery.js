    ...
    save = async() =>{
        try {
            ...
            if(!this.props.offline) {
                if(this.props.isNew) {
                    temp = await axios.post(axios.fixUrl('/deliveries'), this.props.value);
            ...
            <React.Fragment>
                <CardHeader
                    title={
                        ...
                        <Typography variant="h5" component="div">
                            Delivery # {this.props.value._links.self.href.split("/")[this.props.value._links.self.href.split("/").length - 1]}
                        </Typography>:
                        <Typography variant="h5" component="div">
                            Delivery
                        </Typography>
                ...
                <CardContent className="aggre-gate-root-card-content-style">
                    <Typography className="aggre-gate-root-typography-style" color="text.secondary">
                        ...
                        <Number name="quantity" label="quantity" onChange={this.props.onChange} value={this.props.value.quantity?this.props.value.quantity:""} editMode={this.props.editMode}/>
                        <Number name="orderId" label="orderId" onChange={this.props.onChange} value={this.props.value.orderId?this.props.value.orderId:""} editMode={this.props.editMode}/>
                    </Typography>
                </CardContent>
                <CardActions>
